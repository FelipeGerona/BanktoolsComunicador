...
class Portabilidade{
    ...
    public static function sendPortabilidadeMovimento($convenio, $movimento){
        $url = "portabilidade/{$convenio->CODIGO_BANKTOOLS}";
        $header = array(
        ...
        if($movimento->ADE_REFIN) $data['Ade'] = $movimento->ADE_REFIN;
    ...
    public static function getPortabilidadeMovimento($convenio, $movimento){
        $url = "portabilidade/{$convenio->CODIGO_BANKTOOLS}/{$movimento->BANKTOOLS_CODIGO}";
        $header = array(
            "accept: application/json",
            "authorization: {$GLOBALS['API_TOKEN']}",
            "Content-Type: application/json"
